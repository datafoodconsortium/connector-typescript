...
test('Address', async (t) => {
	await t.test('#constructor', async (t) => {
		...
		const obj = new Address({
			...
			street: "yglfsapiok",
			postalCode: "zbcrgynqwy",
			city: "pqclxuvlsc",
			country: "dhesyztgun",
			latitude: 0.19837242,
			longitude: 0.79422385,
			region: "ngsnunbltp"
		});
