...
test('Price', async (t) => {
	await t.test('#constructor', async (t) => {
		...
		const ssoapnxoco = new SKOSConcept({ connector, semanticId: 'http://base.com/sruouvuwso' });
		const obj = new Price({
			connector,
			value: 0.720377,
			vatRate: 0.016867816,
