...
const PRODUCT_OPTION_SEM_TYPE = "dfc-b:ProductOption";
export default class ProductOption extends SemanticObject {
    constructor(parameters) {
        const type = PRODUCT_OPTION_SEM_TYPE;
        if (parameters.other) {
            super({
    ...
    addReferenceProductionOptionValue(productOptionValue) {
    ...
    removeReferenceProductionOptionValue(productOptionValue) {
        throw new Error("Not yet implemented.");
    }
    setDate(date) {
        this.setSemanticPropertyLiteral("dfc-b:date", date);
    }
    setReferenceProductionOptionValue(productOptionValues) {
    ...
    getReferenceProductionOptionValue(options) {
        var _a, e_1, _b, _c;
