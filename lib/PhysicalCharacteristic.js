...
const PHYSICAL_CHARACTERISTIC_SEM_TYPE = "dfc-b:PhysicalCharacteristic";
export default class PhysicalCharacteristic extends Characteristic {
    constructor(parameters) {
        const type = parameters.semanticType ? parameters.semanticType : PHYSICAL_CHARACTERISTIC_SEM_TYPE;
        if (parameters.other) {
            super({
