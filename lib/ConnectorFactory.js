...
export default class ConnectorFactory {
    ...
    createCertification(parameters) {
        return new Certification(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createDeliveryStep(parameters) {
        return new DeliveryStep(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createOrganization(parameters) {
        return new Organization(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createPickUpStep(parameters) {
        return new PickupStep(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createProductOption(parameters) {
        return new ProductOption(Object.assign({ connector: this.connector }, parameters));
    }
    createProductOptionValue(parameters) {
        return new ProductOptionValue(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createRoute(parameters) {
        return new Route(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createTemplateSaleSession(parameters) {
        return new TemplateSaleSession(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createVariant(parameters) {
        return new Variant(Object.assign({ connector: this.connector }, parameters));
    }
    createVariantCharacteristic(parameters) {
        return new VariantCharacteristic(Object.assign({ connector: this.connector }, parameters));
    }
    ...
    createFromType(type) {
        ...
        const prefix = "http://w3id.org/dfc/ontology/v2.0.0/src/DFC_BusinessOntology.owl#";
        switch (type) {
            case prefix + "Address":
