...
export default class Organization extends Agent {
    ...
    getProposedTechnicalProducts(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, properties_8 = __asyncValues(properties), properties_8_1; properties_8_1 = yield properties_8.next(), _a = properties_8_1.done, !_a;) {
                    _c = properties_8_1.value;
                    _d = false;
                    try {
                        const semanticId = _c;
                        const semanticObject = yield this.connector.fetch(semanticId, options);
                ...
                try {
                    if (!_d && !_a && (_b = properties_8.return)) yield _b.call(properties_8);
                }
