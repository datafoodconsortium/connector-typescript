...
const VIRTUAL_PLACE_SEM_TYPE = "dfc-b:VirtualPlace";
export default class VirtualPlace extends SemanticObject {
    constructor(parameters) {
        const type = VIRTUAL_PLACE_SEM_TYPE;
        if (parameters.other) {
            super({
...
//# sourceMappingURL=VirtualPlace.js.map