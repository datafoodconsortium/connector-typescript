...
export default class Connector {
    ...
    loadFacets(facets) {
        return __awaiter(this, void 0, void 0, function* () {
            const prefix = "http://static.datafoodconsortium.org/data/facets.rdf#";
            this.FACETS = yield this.importThesaurus(facets, prefix);
        });
    }
    loadMeasures(measures) {
        return __awaiter(this, void 0, void 0, function* () {
            const prefix = "http://static.datafoodconsortium.org/data/measures.rdf#";
            this.MEASURES = yield this.importThesaurus(measures, prefix);
        });
    }
    loadProductTypes(productTypes) {
        return __awaiter(this, void 0, void 0, function* () {
            const prefix = "http://static.datafoodconsortium.org/data/productTypes.rdf#";
